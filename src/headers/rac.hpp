...
namespace rac
{
    ...
    // f => -2345678.7890 => 13
    f32 MAX_F32_FOR_FULL_REP = 9999999.9999f - F32_EPSILON;
    f32 MIN_F32_FOR_FULL_REP = -9999999.9999f + F32_EPSILON;
    u64 SIGN_CHAR_CT = 1;
    u64 F32_DELIM_CHAR_CT = 1;
    u64 F32_STR_CHAR_CT = 11 + SIGN_CHAR_CT + F32_DELIM_CHAR_CT;
