...
namespace rac::rnd::SplitMix
{
    ...
    public:
        ...
        MAY_INLINE static void Init(std::mt19937& gen)
        {
            ...
            splitmix_state = seeds[distr(gen)];
        }
        MAY_INLINE static void Init(u64 input_seed)
        {
            ...
            mut_u64 transformed_seed = input_seed ^ seeds[distr(rnd_gen)];
            transformed_seed ^= transformed_seed << 20;
            transformed_seed ^= transformed_seed >> 41;
