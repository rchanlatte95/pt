...
namespace rac::gfx
{
    ...
    Color::mut_Color(u8 _r, u8 _g, u8 _b, u8 _a)
    {
        b = _b;
        g = _g;
        r = _r;
    ...
    Color::mut_Color(f32 _r, f32 _g, f32 _b, f32 _a)
    {
        b = (u8)(_b * 255.999f);
        g = (u8)(_g * 255.999f);
        r = (u8)(_r * 255.999f);
    ...
    Color::mut_Color(u32 color_code)
    {
        r = (u8)(color_code >> 24);
    ...
    Color::mut_Color(i32 color_code)
    {
        r = (u8)(color_code >> 24);
        g = (u8)((color_code & 0x00FF0000) >> 16);
        b = (u8)((color_code & 0x0000FF00) >> 8);
    ...
    Color::mut_Color(v3_ref v, u8 _a)
    {
    ...
    MAY_INLINE Color Color::Mix(Color from, Color to, f32 f)
    {
        f32 from_rf = from.r;
        f32 from_gf = from.b;
        f32 from_bf = from.b;
    ...
    INLINE f32 Color::LinearToGamma(f32 linear_color_component) const noexcept
    {
        return powf((f32)linear_color_component * INV_U8_MAX, INV_GAMMA);
    }
    INLINE f32 Color::GammaToLinear(f32 gamma_color_component) const noexcept
    {
        return powf((f32)gamma_color_component * INV_U8_MAX, GAMMA);
    }
    INLINE Color Color::Luminance() const noexcept
    {
    ...
    INLINE u32 Color::GetU32() const noexcept
    {
        return *(u32ptr(&r));
    }
    INLINE Color::operator u32() const noexcept
    {
        return GetU32();
    }
    INLINE i32 Color::GetI32() const noexcept
    {
        return *(i32ptr(&r));
    }
    INLINE Color::operator i32() const noexcept
    {
        return GetI32();
    }

    INLINE Color_ref Color::operator=(Color_ref rhs) noexcept
    {
        b = rhs.b;
        g = rhs.g;
        r = rhs.r;
    ...
    INLINE Color_ref Color::operator=(u32 color_code) noexcept
    {
        r = (u8)(color_code >> 24);
        g = (u8)((color_code & 0x00FF0000) >> 16);
        b = (u8)((color_code & 0x0000FF00) >> 8);
    ...
    INLINE Color_ref Color::operator=(i32 color_code) noexcept
    {
    ...
    INLINE static_strings::mut_cachestr Color::ToStr() const noexcept
    {
    ...
    INLINE static_strings::mut_cachestr Color::ToPpmStr() const noexcept
    {
        u64 MAX = static_strings::MAX_CACHESTR_LEN;
        static_strings::mut_cachestr res;
    ...
    Colorf::mut_Colorf(u8 _r, u8 _g, u8 _b, u8 _a)
    {
        r = _r * INV_U8_MAX;
        g = _g * INV_U8_MAX;
        b = _b * INV_U8_MAX;
    ...
    Colorf::mut_Colorf(f32 _r, f32 _g, f32 _b, f32 _a)
    {
        r = _r;
        g = _g;
        b = _b;
    ...
    Colorf::mut_Colorf(v3_ref v, f32 _a)
    {
        v3 norm_v = (v.Norm() + v3::ONE) * 0.5f;
        r = norm_v.x;
        g = norm_v.y;
    ...
    // Linearly interpolate from one color to another based on a
    MAY_INLINE Colorf Colorf::Mix(Colorf from, Colorf to, f32 a)
    {
    ...
    INLINE f32 Colorf::LinearToGamma(f32 linear_color_component) const noexcept
    {
        return powf(linear_color_component, INV_GAMMA);
    }
    INLINE f32 Colorf::GammaToLinear(f32 gamma_color_component) const noexcept
    {
        return powf(gamma_color_component, GAMMA);
    }
    INLINE Colorf Colorf::ToLinear() const noexcept
    {
        return Colorf(LinearToGamma(r), LinearToGamma(g), LinearToGamma(b), opacity);
    }
    INLINE Colorf Colorf::ToGamma() const noexcept
    {
        return Colorf(GammaToLinear(r), GammaToLinear(g), GammaToLinear(b), opacity);
    }

    INLINE Colorf Colorf::Luminance() const noexcept
    {
        f32 rY = LUMA_REC709_R * LinearToGamma(r);
        f32 gY = LUMA_REC709_G * LinearToGamma(g);
        f32 bY = LUMA_REC709_B * LinearToGamma(b);
    ...
    INLINE Color Colorf::ToColor() const noexcept { return Color(*this); }
    INLINE Colorf::operator Color() const noexcept { return ToColor(); }

    INLINE Colorf_ref Colorf::operator=(Colorf_ref rhs) noexcept
    {
        b = rhs.b;
        g = rhs.g;
        r = rhs.r;
    ...
    mut_f32 Colorf::operator [] (i32 i) const { return *(&r + i); }
    mut_f32ref Colorf::operator [] (i32 i) { return *(&r + i); }

    INLINE static_strings::mut_cachestr Colorf::ToStr(u32 decimal_places) const noexcept
    {
        u64 MAX = static_strings::MAX_CACHESTR_LEN;
        static_strings::mut_cachestr res;
